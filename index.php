...
<body>
	<div>
		<button type="button" data-bs-toggle="modal" data-bs-target="#Modal">Login</button>
		<button onclick="window.location.href = 'php/add_noticia.php'">Cadastrar Notícia</button>
		<button onclick="window.location.href = 'php/add_categoria.php'">Cadastrar Categoria</button>
